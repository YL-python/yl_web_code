...
var MainManager = function() {
    ...
    function i(a) {
        (X = !X) ? ($("#bt_backtrack a").text("背景音乐: 开启"),
    ...
    function r() {
        ...
        p && $("#bt_fs").stop().fadeIn(200, "linear"),
    ...
    ;
    for (var l = 0, s = 6e4 / 280, d = Math.floor(32 * Math.random()), h = 0, c = [], f = 0, u = 0; 32 > u; u++)
        c[u] = u;
    var v = !1;
    ...
    , k = new function() {
        ...
        var d = function(a, e) {
          ...
          , h = function(a, e) {
            function n() {
                ...
                var e, n;
                if (0 == o)
                    for (var t = 0; t < h.rotation; t += 30)
                        e = (s * t + l) * Math.PI / 180,
                        n = Math.cos(e) * a,
                        e = Math.sin(e) * a,
                        c.lineTo(n, e);
                else
                    for (t = 360; h.rotation < t; t -= 30)
                        e = (s * t + l) * Math.PI / 180,
                        n = Math.cos(e) * a,
                        e = Math.sin(e) * a,
                        c.lineTo(n, e);
        ...
        this.start = function() {
            ...
            $(window).on("keydown", e),
            $(window).on("keyup", n)),
            (m || window.TouchEvent) && ($("#view").on("touchstart", t),
        ...
        ,
        this.end = function() {
            m || ($("#view").off("mousedown", t),
            $(window).off("mousemove", i),
            $(window).off("mouseup", o),
            $(window).off("keydown", e),
            $(window).off("keyup", n)),
            (m || window.TouchEvent) && ($("#view").off("touchstart", t),
            $(window).off("touchmove", i),
            $(window).off("touchend", o)),
        ...
        , function(a, e) {
            ...
            function t() {
                ...
                case 0:
                    ...
                    for (var a = 1; a < h; a++)
                        f.lineTo(d[a].x, d[a].y);
                    f.lineTo(c.x, c.y);
                    break;
                case 1:
                    for (f.moveTo(c.x, c.y),
                    a = h; a <= i; a++)
                        f.lineTo(d[a].x, d[a].y)
                }
            }
        ...
        , f], k = [function(a, e) {
            ...
            this.play = function() {
                ...
                .5 > Math.random() ? (h.rotation = 0,
                h.x = 0,
                h.y = 0) : (h.rotation = Math.PI,
                h.x = w,
                h.y = M);
                for (var u = l = 0; u <= e; u++) {
                    var v = {
        ...
        for (var X, F = 16 * Math.random(), G = [], B = 0; B < P.length + k.length; B++)
            G[B] = [];
        var z, E = [13430510, 8965324, 9099756, 961181, 1089457, 34969, 13934238, 16110792, 15488645, 16531063, 5853015, 3222317], R = [13430510, 8965324, 9099756, 961181, 1089457, 34969, 13934238, 16110792, 15488645, 16531063, 5853015, 3222317], S = E.length, A = 0, D = 0
    }

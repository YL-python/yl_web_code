...
function __checkInit() {
    "undefined" == typeof jQuery ? setTimeout(__checkInit, 10) : $(function() {
        if ($("meta:last").after('<meta name="theme-color" content="#000000">'),
        ...
        _isJapanese || null != document.getElementById("google_translate_element") && $.getScript("//translate.google.com/translate_a/element.js?cb=__googleTranslateElementInit", function() {
            ...
            setInterval(function() {
                $(".goog-te-banner-frame").length && ("none" == $(".skiptranslate").css("display") ? e && ("block" == $("#menu_sp").css("display") ? $("#menu, #menu_sp").css("top", 0) : $("#menu").css("top", 0)) : (e && ("block" == $("#menu_sp").css("display") ? $("#menu, #menu_sp").css("top", 39) : $("#menu").css("top", 39)),
                480 > $(window).width() ? $("iframe:first").contents().find(".goog-te-button").css("display", "none") : $("iframe:first").contents().find(".goog-te-button").css("display", "block"),
                0 != t.tw && $("#goog-gt-tt").css({
                    display: "none",
                    opacity: 0
                })))
            }, 100);
            var n = setInterval(function() {
                ...
                $("iframe:first").contents().find(".goog-te-banner").css("background", "#FFF"),
        ...
        !_active) {
            ...
            if (aidn.util.checkJapanese() && (e = aidn.constant.advUrlJa),
            e = '<a href="' + e + '" target="_blank"><div class="adv_con"><p class="text">' + aidn.constant.advTex + "</p>",
            e += '<p class="image"><img src="' + aidn.constant.advImg + '" alt="' + aidn.constant.advAlt + '" /></p>',
            e += "</div></a>",
            0 < $(".adv").length)
                $(".adv").html(e),
                ...
                var t = $("#common_back");
                0 < t.length && ($("body").css("overflow", "auto"),
                t.after(e))
            }
        }
    })
...
aidn.config = {
    init: function() {
        ...
        (0 >= this.clHeight || 0 >= this.clWidth) && (this.clWidth = this.scWidth,
        this.clHeight = this.scHeight),
        (0 >= this.inHeight || 0 >= this.inWidth) && (this.inWidth = this.clWidth,
...
aidn.audio = {
    ...
    getPath: function(e) {
        for (var t = e.length, n = 0; n < t; n++) {
            var i = e[n]
              , o = i.toLowerCase();
            if (aidn.audio.availableMP3 && o.indexOf(".mp3"))
                break;
            if (aidn.audio.availableOgg && o.indexOf(".ogg"))
                break;
            if (aidn.audio.availableWav && o.indexOf(".wav"))
                break
        }
        return n == t && (i = null),
        i
...
aidn.ref = {
    init: function(e) {
        0 < this.__total && e != this.__interval && (clearInterval(this.__sid),
    ...
    removeInterval: function(e) {
        for (var t = 0; t < this.__total; t++)
            this.__list[t].func == e && (delete this.__list[t],
            this.__list.splice(t, 1),
            this.__total--);
        0 == this.__total && clearInterval(this.__sid)
    },
    __update: function() {
        for (var e, t = aidn.ref.__list, n = aidn.ref.__total, i = aidn.ref.__interval, o = 0; o < n; o++)
            e = t[o],
            e.time += i,
            e.delay < e.time && (e.time -= e.delay,
            e.func())
    },
    __interval: 10,
    __sid: -1,
...
aidn.util = {
    ...
    checkJapanese: function() {
        ...
        !!("ja" == this.getLanguage() || this.lowerAndroid(2.4) && 0 < navigator.userAgent.toLowerCase().indexOf("ja-jp"))
    },
    ...
    getCookie: function(e) {
        ...
        return 0 <= i && (t = i + n.length,
        -1 == (n = e.indexOf(";", t)) && (n = e.length),
        t = decodeURIComponent(e.substring(t, n))),
        t
    },
    ...
    needExpandArea: function(e) {
        var t = navigator.userAgent
          , n = 0 <= t.indexOf("iPhone") || 0 <= t.indexOf("iPod");
        return (n = n && 0 <= t.indexOf("Version/") && 600 > Math.max(window.screen.width, window.screen.height)) && 1 == e && ($("html,body").css("position", "static"),
...
aidn.window = {
    ...
    resize: function(e, t) {
        ...
        aidn.window._isFit && $(window).on("touchmove", function(e) {
            e.preventDefault()
        }),
...
aidn.social = {
    ...
    initTw: function() {
        if (!(0 > location.href.indexOf("http"))) {
            var e, t = document.getElementsByTagName("script")[0], n = /^http:/.test(document.location) ? "http" : "https";
            document.getElementById("twitter-wjs") || (e = document.createElement("script"),
            e.id = "twitter-wjs",
            e.src = n + "://platform.twitter.com/widgets.js",
...
aidn.extra = {
    Button: function(e, t) {
        function n() {
            ...
            a <= c && (clearInterval(r),
            i.text(o)));
            for (var e = o.substr(0, c), t = c; t < a; t++)
...
aidn.Audio = function() {
    ...
    this.play = function(i, a, s, c, u) {
        ...
        d.play(),
        0 < c && "undefined" != typeof jQuery ? (r.volume = 0,
        $(r).stop().animate({
            volume: u
...
aidn.WebAudio = function() {
    ...
    if (void 0 !== aidn.___waContext)
        this._context = t = aidn.___waContext;
    else {
        try {
    ...
    this.load = function(e, i, o) {
        function a() {
            t.decodeAudioData(f ? r.buffer : b.response, function(e) {
                if (0 <= w) {
                    ...
                    for (p = e.length - a,
                    o = t.createBuffer(r, p, t.sampleRate),
                    f = 0; f < r; f++) {
        ...
        if (!t)
            return !1;
        if (t.createBufferSource().start(0),
        n = null,
        !(e = aidn.audio.getPath(e)) && !f)
            return !1;
        if (f)
            a();
        else {
    ...
    this.play = function(f, g, w, b, x, E) {
        ...
        n) {
            ...
            if (i.start ? i.start(t.currentTime + E, f) : i.noteOn(f),
            v = t.currentTime - f,
            this._source = i,
            this.nodeGain = a,
            0 < b && "undefined" != typeof jQuery ? (m.volume = 0,
            $(m).stop().animate({
                volume: x
            }, 1e3 * b, "easeInSine")) : m.volume = x,
            w)
                var F = setInterval(function() {
                    0 < m.time && (clearInterval(F),
                    w())
                }, 10)
        } else
            _ = !0,
...
aidn.AutoAudio = function(e, t, n) {
    ...
    0 == i) {
        ...
        var d = setInterval(function() {
            document.getElementById("flash_audio").loadFunc && (clearInterval(d),
            o = document.getElementById("flash_audio"),
            t(i))
        }, 100)
    } else
        this.audio = o = 1 == i ? new aidn.WebAudio : new aidn.Audio,
    ...
    this.load = function() {
        ...
        0 == i) {
            ...
            for (e = 0; e < arguments[0].length; e++)
                0 > arguments[0][e].indexOf(".swf") && t.push(arguments[0][e]);
            arguments[0] = t
        }
